...
def get_compute_capabilities():
    ...
    # Base compute capabilities for 30xx and 40xx series
    ...
    # Try to detect actual GPU capabilities if possible
    try:
        if torch.cuda.is_available():
            detected_caps = []
...
# CUDA version specific flags
if cuda_major >= 12:
    # CUDA 12+ specific optimizations
    nvcc_flags.append('--allow-unsupported-compiler')
elif cuda_major == 11 and cuda_minor >= 8:
    # CUDA 11.8+ specific flags
    pass
