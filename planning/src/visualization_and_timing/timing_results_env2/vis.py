...
directory = './timing_results_env2'  # change this to your actual directory
...
# Create a finer grid
k_fine = np.linspace(min(ks), max(ks), 10)
s_fine = np.linspace(min(states), max(states), 10)
...
ax.set_title("Graph Generation Time for a 16 Obstacle Environment", fontsize=20)
